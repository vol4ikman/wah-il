<template lang="html">
    <main class="home-page" :class="{isRtl:isRtl}">
        ...
        <div class="main-sections-wrapper" v-if="page_data.sections_pro">
            <div class="section-wrapper">

                <div class="row section">
                    <div class="small-12 columns">
                        <div class="section-title title">
                            <h1 class="title-tag"><span>{{page_title}}</span></h1>
                        </div>
                    </div>
                </div>

                <div v-for="(item, index) in page_data.sections_pro" class="section content-section image-section">
                    ...
                    <div class="row" v-else="item.acf_fc_layout == 'text_only'">
                        <div class="small-12 content-column-wrapper">
                            <div class="section-title title">
...
export default {
    ...
    data(){
        return {
            isRtl: true,
            showModal: false,
            page_title: 'WP Accessibility Helper PRO - עוזר נגישות פרו'
        }
    },
    components: {
        modal
